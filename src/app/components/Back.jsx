...
const Back = () => {
  ...
  return (
    <div className="section_5 w-full h-screen relative flex justify-center items-start">
      <div className="w-[80%] xs:w-[50%] md:w-[70%] 2xl:w-[40%] flex flex-col gap-[4vh] lg:gap-[50px] justify-center items-center mt-[25vh] lg:mt-[15vh]">
        <p className="width_text opacity-0 text-[2.5rem] lg:text-[54px] font-semibold font-Oswald text-main-color text-nowrap">
          Width 1.900 mm
        </p>
